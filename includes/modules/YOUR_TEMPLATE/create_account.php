 ...
 *
 * @package modules
 * @copyright Copyright 2012-2013, Vinos de Frutas Tropicales (lat9): phpBB Notifier-Hook Integration
...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
  ...
  if (strlen($email_address) < ENTRY_EMAIL_ADDRESS_MIN_LENGTH) {
    ...
    } /*-bof-a-zcbb*/ elseif (is_object($bb) && $bb->check_email_not_used($email_address) != bb::STATUS_OK) {
      $error = true;
      $messageStack->add('create_account', (method_exists($bb, 'get_bb_message') && $bb->get_bb_message() != '') ? $bb->get_bb_message() : (ENTRY_EMAIL_ADDRESS_ERROR_EXISTS . ' (' . $bb->get_bb_name() . ')') );
    }
/*-eof-a-zcbb*/
  }

/*-bof-c-zcbb*/
  if (is_object($bb) && $bb->is_enabled()) {
/*-eof-c-zcbb*/
...
/*-eof-a-zcbb*/
        ...
        } /*-bof-c-zcbb*/ elseif /*-eof-c-zcbb*/ ($bb->check_nick_not_used($nick) != bb::STATUS_OK) {
          $error = true;
/*-bof-c-zcbb*/
          $messageStack->add('create_account', (method_exists($bb, 'get_bb_message') && $bb->get_bb_message() != '') ? $bb->get_bb_message() : (ENTRY_NICK_DUPLICATE_ERROR . ' (' . $bb->get_bb_name() . ')') );
/*-eof-c-zcbb*/
        }
/*-bof-a-zcbb*/
      }
...
/*-bof-c-zcbb*/
    // Create account on bulletin-board
    if (is_object($bb) && $nick != '') {
      $bb->create_account($nick, $password, $email_address);
    }
/*-eof-c-zcbb*/
    ...
    // initial welcome
    $email_text .=  EMAIL_WELCOME /*-bof-a-zcbb*/ . (($bb && $bb->is_enabled() && defined('BB_EMAIL_WELCOME') && $nick != '') ? BB_EMAIL_WELCOME : '') /*-eof-a-zcbb*/;
