 ...
 *
 * @package page
 * @copyright Copyright 2012-2014, Vinos de Frutas Tropicales (lat9): phpBB Notifier-Hook Integration
...
/*-bof-c-zcbb*/
  $check_customer_query = "SELECT customers_firstname, customers_lastname, customers_password, customers_id, customers_nick
...
/*-bof-a-zcbb*/
    if (is_object($bb) && $check_customer->fields['customers_nick'] != '') {
      $bb->change_password($check_customer->fields['customers_nick'], $new_password);
    }
/*-eof-a-zcbb*/
