 ...
 * @copyright Copyright 2013, lat9: phpBB Notifier-Hook Integration
...
<?php } ?>
<?php /*-bof-c-zcbb*/ if (is_object($bb) && $bb->is_enabled()) /*-eof-c-zcbb*/ { ?>
            <li><?php echo '<a href="' . zen_href_link(/*-bof-c-zcbb*/ $bb->get_bb_url() /*-eof-c-zcbb*/, '', 'NONSSL', false, '', true) . '" target="_blank">' . BOX_BBINDEX . '</a>'; ?></li>
<?php } ?>
