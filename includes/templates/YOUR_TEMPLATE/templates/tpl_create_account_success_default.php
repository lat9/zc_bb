...
<div id="createAcctSuccessMainContent" class="content"><?php echo TEXT_ACCOUNT_CREATED /*-bof-a-zcbb*/ . (($bb && $bb->is_enabled() && $nick != '' && defined('BB_TEXT_ACCOUNT_CREATED')) ? BB_TEXT_ACCOUNT_CREATED : '') /*-eof-a-zcbb*/; ?></div>
