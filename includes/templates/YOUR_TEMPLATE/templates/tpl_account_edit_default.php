...
<?php echo zen_draw_form('account_edit', zen_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL'), 'post', 'onsubmit="return check_form(account_edit);"') . zen_draw_hidden_field('action', 'process') . zen_draw_hidden_field('nick', $account->fields['customers_nick']); /*-lat9-c-zcbb*/ ?>
...
<?php
/*-bof-a-zcbb*/  
  if ($account->fields['customers_nick'] != '' && is_object($bb) && $bb->is_enabled()) {
?>
<label class="inputLabel"><?php echo ENTRY_NICK; ?></label><span id="nick"><?php echo $account->fields['customers_nick']; ?></span>
<br class="clearBoth" />
<?php
  }
/*-eof-a-zcbb*/
