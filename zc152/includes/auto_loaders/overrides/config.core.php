 ...
 *
 * @package initSystem
 * @copyright Copyright 2013-2014 Vinos de Frutas Tropicales (lat9): Convert bulletin-board to notifier hooks
 ...
 */
  ...
  $autoLoadConfig[0][] = array('autoType'=>'class',
                                'loadFile'=>'class.bb.php'); // Changed/lat9 (was class.phpbb.php)
  $autoLoadConfig[0][] = array('autoType'=>'class',
...
/**
 * Breakpoint 55.  Instantiate the notifier-hook bb class.
 * NOTE: Any bulletin-board interface (e.g. phpBB) that is hooking into
 *       this class should be instantiated at Breakpoint 54, PRIOR to this
 *       class's instantiation but after this class has been loaded at
 *       Breakpoint 0.
 */
/*-bof-c-zc_bb*/
  $autoLoadConfig[55][] = array('autoType'=>'classInstantiate',
                                'className'=>'bb',
                                'objectName'=>'bb');
/*-eof-c-zc_bb*/
/**
